    ...
    try {
        ...
        profileSection.innerHTML = `
            <div class="user-profile">
                <img src="${user.foto_perfil || '/images/profile/default-avatar.png'}" alt="${user.nombre}" class="profile-avatar">
...
async function handleLike(post, postElement) {
    ...
    try {
        ...
        if (data.success) {
            ...
            postElement.querySelector('.like-count').textContent = `${post.like_count} Likes`;
        } else {
